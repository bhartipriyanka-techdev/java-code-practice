...
public class InsertMultipalRecord {
    public static void main(String[] args) {
        Connection con = null;
        Statement stmt = null;
        String qry1 = "insert into record.student values(102,'Piya','piya@gmail.com','Patna')";
        String qry2 = "insert into record.student values(103,'Raaz','raaz@gmail.com','Patna')";
        try{
